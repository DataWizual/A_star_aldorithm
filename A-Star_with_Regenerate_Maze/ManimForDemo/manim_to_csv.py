...
class Maze(Scene):
    def construct(self):
        ...
        descript = Tex(
            r"Writing cell sides top, right, bottom, left to file", font_size=40)
        descript.set_color('#ffdd00')
        descript[0][16:19].set_color('#ff00ff')
        descript[0][20:25].set_color('#ff00ff')
        descript[0][26:32].set_color('#ff00ff')
        descript[0][33:37].set_color('#ff00ff')
        descript.set_x(2).set_y(3)
        self.play(Write(descript))

        self.play(Create(squares))
        self.maze_draw(df_2, squares)
    ...
    def maze_read(self, df_1, squares):
        ...
        description.set_color('#ffffff')
        description.set_x(0).set_y(2.5)
    ...
    def read_lines(self, x, y, walls, squares, y_coor):
        ...
        if walls['top']:
            ...
            self.play(line.animate.move_to(position))
        ...
        right_coords = None
        if walls['right']:
            text = Tex(r"right: ", r"True,", font_size=30)
            ...
            text = Tex(r"right: ", r"False,", font_size=30)
            text[0].set_color("#ffffff")
        ...
        bottom_coords = None
        if walls['bottom']:
            text = Tex(r"bottom: ", r"True,", font_size=30)
            text[0].set_color("#ffffff")
            text[1].set_color("#00ff00")
            ...
            text = Tex(r"bottom: ", r"False,", font_size=30)
            text[0].set_color("#ffffff")
            text[1].set_color("#ef3817")
            text.next_to(right_coords, RIGHT, buff=0.2)
            self.play(FadeIn(text))
